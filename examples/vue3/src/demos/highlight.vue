...
const text1 = 'This is an important message about Vue.js development.'

// Scenario 2: Multiple keywords
const text2 = 'Vue and React are popular JavaScript frameworks for building modern web applications.'

// Scenario 3: Case sensitive
const text3 = 'Vue is great. vue is also great. VUE is still great.'

// Scenario 4: Custom style
const text4 = 'Search results will highlight matching keywords for better visibility.'

// Dynamic highlight
const searchText = ref('Vue')
...
const multipleCode = `<p v-highlight="['Vue', 'React', 'JavaScript']">
  Vue and React are popular JavaScript frameworks.
</p>`

const optionsCode = `<p v-highlight="{
  keywords: 'highlight',
