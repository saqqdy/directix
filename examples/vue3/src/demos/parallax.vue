...
const optionsCode = `<div v-parallax="{
  speed: 0.5,
  reverse: true,
  horizontal: false,
...
const composableCode = `import { useParallax } from 'directix'

const el = ref<HTMLElement>()

const { enable, disable, setSpeed } = useParallax(el, {
  speed: 0.5,
  enabled: true
})
...
<template>
	<div class="demo-page">
		...
		<DemoSection title="Composable API - useParallax" description="Using useParallax composable">
			<div class="demo-box">
				<div ref="parallaxEl" class="parallax-layer">
					<div class="parallax-content">
						<p>Using useParallax composable</p>
					</div>
				</div>
			</div>
