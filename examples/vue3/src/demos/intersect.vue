...
const handleItemIntersect = (index: number, isIntersecting: boolean) => {
	itemStates.value[index] = isIntersecting
}
...
const triggerOnce = (index: number) => {
	triggeredItems.value[index] = true
}
...
const handleVisibilityChange = (_isIntersecting: boolean, entry: IntersectionObserverEntry) => {
...
<template>
	<div class="demo-page">
		...
		<DemoSection title="Track Multiple Elements" description="Scroll to see items highlight when they enter the container">
			<div class="demo-box">
		...
		<DemoSection title="Enter/Leave Counter" description="Count how many times element enters and leaves">
			<div class="demo-box">
		...
		<!-- Scenario 3: Once mode -->
		<DemoSection title="Once Mode" description="Each item triggers only once, then stops observing">
			<div class="demo-box">
				<div class="status-row">
		...
		<!-- Scenario 4: Visibility percentage -->
		<DemoSection title="Visibility Percentage" description="Track how much of the element is visible">
			<div class="demo-box">
			...
			<table class="api-table">
				...
				<tbody>
					...
					<tr>
						...
						<td>Function</td>
						<td>-</td>
						<td>Callback with isIntersecting boolean and entry</td>
					</tr>
					<tr>
						<td>root</td>
						<td>Element</td>
