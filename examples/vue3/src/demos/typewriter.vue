...
const basicText = 'Hello, World! Welcome to Directix.'

// Scenario 2: With options
const slowText = 'This text types slowly...'

// Scenario 3: Loop mode
const loopText = 'This message will loop forever!'

// Scenario 4: Custom cursor
const customCursorText = 'Custom cursor style'

// Dynamic text
const dynamicText = ref('Type something new!')
...
const optionsCode = `<span v-typewriter="{
...
const loopCode = `<span v-typewriter="{
  text: 'Loop message',
  loop: true,
  deleteDelay: 1000,
  deleteSpeed: 30
		...
		<DemoSection title="Dynamic Text" description="Change text dynamically">
			<div class="demo-box">
				...
				<div class="controls">
					...
					<button @click="dynamicKey++" class="btn">Replay</button>
				</div>
			</div>
		</DemoSection>
