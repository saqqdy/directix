					...
					'/guide/': [
						{
							items: [
								...
								{ link: '/guide/community-plugins', text: 'Community Plugins' },
								{ link: '/guide/vscode-extension', text: 'VS Code Extension' },
								{ link: '/tutorials/', text: 'Video Tutorials' },
							],
					...
					'/zh/guide/': [
						{
							items: [
								...
								{ link: '/zh/guide/community-plugins', text: '社区插件' },
								{ link: '/zh/guide/vscode-extension', text: 'VS Code 插件' },
								{ link: '/tutorials/', text: '视频教程' },
							],
							text: '开始',
						},
						{
