...
**Playground 功能：**
- 在线指令配置器
- 实时代码生成（Vue 2/3 模板、Composable、Nuxt、TypeScript 类型）
- 44+ 指令完整配置支持
- 参数可视化编辑器
- 代码语法高亮
- 一键复制/下载代码
...
**新增文件：**
- `playground/` - 独立 Playground 应用
- `docs/playground.md` - Playground 文档页面
- `docs/zh/playground.md` - Playground 中文页面
- `docs/.vitepress/components/Playground.vue` - 嵌入式 Playground 组件
- `docs/.vitepress/components/DirectiveConfigurator.vue` - 指令配置器组件

**新增组件：**
- `DirectiveSelector` - 指令选择器
- `ConfigPanel` - 配置面板
- `CodePreview` - 代码预览（支持 Code/Preview 切换）
